---
geometry: 'left=.5in,right=.5in,top = 35pt,bottom=23pt'
...
<!--\pagebreak[4]
\fontsize{10}{10}   keep values same to prevent bold font from shrinking when using ** 
\setlength{\parskip}{0mm}
\newcommand{\secfnt}{\fontsize{10}{12}}
\titleformat{\section}{\normalfont\secfnt\bfseries}{\section}{0mm}{}
\titlespacing*{\section}{0mm}{2mm plus 1mm minus 1mm}{0mm plus 1mm minus 1mm}
-->
<!--
...
\begin{adjustwidth}{7mm}{0mm}
 ...
 \textbf{Graduate Wages:} Average wages reported in the graduate survey to 350\% of the poverty level. \par
...
\textbf{Change in Course Completion Rate:} Rate of change in the course completion rate compared to the previous year. \par
\textbf{Retention Rate:} Percent of new program students who started the program two years earlier and either graduated from the program or are still enrolled.  \par
\textbf{Change in Retention Rate:} Rate of change in the retention rate compared to the previous year's cohort. \par
\textbf{Graduation Rate:} Percent of new program students who graduated from the same program within 2 years for diploma programs or 3 years for associate degree programs. \par
\textbf{Change in Graduation Rate:} Rate of change in the graduation rate compared to the previous year's cohort. \par
\end{adjustwidth}

\section{Program Uniqueness}
\begin{adjustwidth}{7mm}{0mm}
...
\textbf{\% Change in FTE:} Rate of change in FTE compared to the previous year. \par
\textbf{FTE \% Change Compared to School:} Rate of change in FTE compared to the MATC average rate of change for that year. \par
\textbf{Program Total Headcount (HC):} Total unique count of program students enrolled in the academic year. \par
\textbf{\% Change in HC:} Rate of change in headcount compared to the previous year. \par
\textbf{HC \% Change Compared to School:} Rate of change in HC compared to the MATC average rate of change for that year. \par
